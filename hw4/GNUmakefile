...
lab4: yfs_client extent_server lock_server lock_tester rpc/rpctest test-homework-3-d test-homework-3-e
lab5: yfs_client extent_server lock_server lock_tester test-homework-3-d\
	 test-homework-3-e
lab6: yfs_client extent_server lock_server test-homework-3-d test-homework-3-e
...
test-homework-3-d=test-homework-3-d.c
test-homework-3-d:  $(patsubst %.c,%.o,$(test-homework-3-d)) rpc/librpc.a

test-homework-3-e=test-homework-3-e.c
test-homework-3-e:  $(patsubst %.c,%.o,$(test-homework-3-e)) rpc/librpc.a
...
l4:
	./mklab.pl 4 0 l4 GNUmakefile test-homework-5-a.pl $(rpclib) $(yfs_client) $(rpctest) $(lock_server)\
	 ...
	 $(lock_demo) $(lock_tester) $(hfiles1) $(hfiles2) $(test-homework-3-d) $(test-homework-3-e)
...
l5:
	./mklab.pl 5 0 l5 GNUmakefile test-homework-5-a.pl $(rpclib) $(yfs_client)\
	 ...
	 $(test-homework-3-d) $(test-homework-3-e)
...
l6:
	./mklab.pl 6 0 l6 GNUmakefile test-homework-5-a.pl $(rpclib) $(yfs_client) $(rpctest)\
	 ...
	 $(hfiles1) $(hfiles2) $(hfiles3) $(lock_tester) $(test-homework-3-d) $(test-homework-3-e)
...
.PHONY : clean
clean : 
	rm -rf rpc/rpctest rpc/*.o rpc/*.d rpc/librpc.a *.o *.d yfs_client extent_server lock_server lock_tester lock_demo rpctest test-homework-3-d test-homework-3-e rsm_tester
